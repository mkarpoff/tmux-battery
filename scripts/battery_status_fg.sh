...
color_charging_default="#[fg=colour5]"
color_full_charge_default="#[fg=colour2]"
color_high_charge_default="#[fg=colour4]"
color_medium_charge_default="#[fg=colour3]" # orange
color_low_charge_default="#[fg=colour1]"
